    ...
    <footer className="bg-forest text-white">
      ...
      <div className="mx-auto max-w-6xl px-5 py-16 md:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-white/40">Product</h3>
          ...
          <div>
            <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-white/40">Company</h3>
            <ul className="space-y-2">
              <li><Link href="/about" className="text-sm text-white/70 hover:text-white">About</Link></li>
              <li><Link href="/privacy" className="text-sm text-white/70 hover:text-white">Privacy</Link></li>
              <li><Link href="/terms" className="text-sm text-white/70 hover:text-white">Terms</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="mb-4 text-sm font-semibold uppercase tracking-wider text-white/40">Connect</h3>
            <ul className="space-y-2">
              <li><a href={SOCIAL_LINKS.instagram} className="text-sm text-white/70 hover:text-white" target="_blank" rel="noopener noreferrer">Instagram</a></li>
              <li><a href={SOCIAL_LINKS.twitter} className="text-sm text-white/70 hover:text-white" target="_blank" rel="noopener noreferrer">Twitter/X</a></li>
              <li><a href={SOCIAL_LINKS.contact} className="text-sm text-white/70 hover:text-white">Contact</a></li>
            </ul>
          </div>
        </div>
